...
function preload()
{
    ...
    picture1_Img = loadImage("./imgs/player1 out.png");
    picture2_Img = loadImage("./imgs/player2won.png");
    picture3_Img = loadImage("./imgs/player2 out.png");
    picture4_Img = loadImage("./imgs/player1won.png");
}
